# RAGCore / CVUM — Comprehensive Diagram Atlas

**Diagram atlas snapshot:** 2026-07-20

**Legend:** blue/solid = **CURRENT**; amber/dashed = **PROPOSED / PHASED**.
**Companion:** `design.md` is the synchronized engineering-design edition of this complete visual set.
