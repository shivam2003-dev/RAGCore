...
- `RETRIEVAL_FUSION_STRATEGY=weighted|rrf` (default `weighted`)
- `RETRIEVAL_RRF_K=60`
- `RETRIEVAL_RRF_DENSE_WEIGHT=1.0`
- `RETRIEVAL_RRF_SPARSE_WEIGHT=1.0`
- `RETRIEVAL_EXACT_ARM_ENABLED=true`
- `RETRIEVAL_RARE_TOKEN_ENABLED=false`
- `RETRIEVAL_RECENCY_DECAY_ENABLED=false`
- `RETRIEVAL_MODEL_RERANKER_ENABLED=false`
- `RETRIEVAL_MODEL_RERANKER_TIMEOUT_MS=1500`
